...
window.DATA = (function () {
  ...
  const GUIDE_CHAPTERS = [
    ...
    { id: 'daily', title: '⑦ 每天必做的五件事', body: [
      '1. 先求一签（首页「游历」→「求签」）：签文给当天的挂机加成，先求再挂最划算。',
    ...
    { id: 'idle', title: '⑩ 挂机分工：让板凳角色去干活', body: [
      '首页「挂机」那块点「派人分工」，可以给 4 条产线各派 1 名领队：闭关修炼（经验）、灵材采集（强化材料）、外围探索（点数）、主神守卫（异界结晶）。',
    ...
    { id: 'bounty', title: '⑪ 限时悬赏与境界', body: [
      ...
      '首页「游历」那段里的「限时悬赏」会显示最快到期的那条还剩多久，别让它白白过期。',
    ...
    { id: 'authority', title: '⑬ 主神权限：高级货币的长线出路', body: [
      ...
      '入口：首页「养成」那一组里的「主神权限」（「👥 轮回者 → 🌱 成长」子页里也有同一项）。',
    ] },
    { id: 'sect', title: '⑭ 主神评级 · 秘术阁 · 游历奇遇', body: [
      ...
      '入口：首页「养成」那一组里的「主神评级」「秘术阁」，游历奇遇在首页「游历」那一组的进度条上，点名字就是完整面板。',
    ] },
